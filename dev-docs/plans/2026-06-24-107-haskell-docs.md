...
| --- | --- |
| [`plcc-haskell-emit`](../../docs/cli/commands/plcc-haskell-emit.md) | Writes `.hs` source files and `interpreter.cabal` to the output directory |
| [`plcc-haskell-build`](../../docs/cli/commands/plcc-haskell-build.md) | Compiles with `cabal build`; requires GHC 9.4+ and cabal 3.0+ on `PATH` |
| [`plcc-haskell-run`](../../docs/cli/commands/plcc-haskell-run.md) | Runs `cabal run interpreter`; requires cabal 3.0+ on `PATH` |
...
See the [Haskell language guide](../../docs/language-guide/languages/haskell.md) for
...
| Command | What it does |
| --- | --- |
| [`plcc-haskell-emit`](../../docs/cli/commands/plcc-haskell-emit.md) | Writes `.hs` source files and an `interpreter.cabal` project file to the output directory |
| [`plcc-haskell-build`](../../docs/cli/commands/plcc-haskell-build.md) | Compiles with `cabal build`; requires GHC 9.4+ and cabal 3.0+ on `PATH` |
| [`plcc-haskell-run`](../../docs/cli/commands/plcc-haskell-run.md) | Runs `cabal run interpreter`; requires cabal 3.0+ on `PATH` |
```
